...
def setUp(self):
    self.user_tharcissie = User(username = 'tharcissie',password = 'ntakarakorwa123', email = 'tharcissieidufashe@gmail.com')
...
def test_check_instance_variables(self):
    ...
    self.assertEquals(self.new_review.user,self.user_tharcissie)
